...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font">
      <div className="container__custom py-24 mx-auto flex items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          ...
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <Link
                  href={"/#feedback"}
                  className="capitalize text-gray-600 hover:text-primary-100">
                  Feedback
                </Link>
              </li>
              <li>
